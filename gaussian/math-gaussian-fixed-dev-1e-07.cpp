...
int main (int argc, char **argv) {
  ...
  double __const_1 = 1.0;
	...
	double ____expr_0 = ((double)((float)__const_4 / (float)(__const_1 * __const_3)) * (double)(exp2f(((float)__const_6 * ((float)((x - ave) * (x - ave)) / ((float)__const_5 * ((float)__const_1 * (float)__const_1)))))));
