...
int main (int argc, char **argv) {
	...
	for(int __r = 0 ; __r < 10000000 ; __r++) {
		FPTT_0 _var_expr_0 = -0.520840781417;
		FPTT_0 _var_expr_1 = 1.87791138194;
		FPTT_0 _var_expr_2 = 9.44861347349;
		...
		FPTT_9 _var_expr_11 = exp((FPTT_9)_var_expr_10);
